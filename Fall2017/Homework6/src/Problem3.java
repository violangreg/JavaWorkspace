...
//****source used: http://www.geeksforgeeks.org/data-structures/linked-list/#singlyLinkedList**** //
public class Problem3<E> {
	private class ListNode<E> implements Comparable<E> {
		...
		@Override // used for partitioning
 ...
 */// source: http://www.geeksforgeeks.org/partitioning-a-linked-list-around-a-given-value-and-keeping-the-original-order/
	public ListNode<E> partition(int x) {
		E casted_x = get(x);
		// creating 3 lists, one less than, equal to, and greater than x. Afterwards will concatenate them together
		ListNode<E> smallerHead = null, smallerLast = null, greaterHead = null, greaterLast = null, equalHead = null, equalLast = null;
	    ...
	    // Fix end of greater linked list to NULL if this list has some node
		if(greaterLast != null)
	...
	public static void main(String[] args) {		
		Problem3<Integer> sort_numbers = new Problem3<Integer>();
		for (int i = 0; i < 10; i++) {
			sort_numbers.add(i);			
		}
		...
		Problem3<Integer> rand_numbers = new Problem3<Integer>();
		for (int i = 0; i < 20; i++) {
		...
		rand_numbers.printList(rand_numbers.partition(5));
	}
}
